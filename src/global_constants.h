...
constexpr layerindex_t LAYER_NONE = ~static_cast<layerindex_t>(0);
...
constexpr eventindex_t EVENT_NONE = ~static_cast<eventindex_t>(0);
...
constexpr stringindex_t STRING_NONE = ~static_cast<stringindex_t>(0);

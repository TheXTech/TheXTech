...
void RenderGL::repaint()
{
    ...
    if(XRender::g_BitmaskTexturePresent && g_ForceBitmaskMerge)
        SuperPrintScreenCenter(g_gameStrings.onScreenWarningSimGIFs2PNGAct, 5, 2, XTColorF(1.0f, 0.7f, 0.5f));
    else if(g_ForceBitmaskMerge)
        SuperPrintScreenCenter(g_gameStrings.onScreenWarningSimGIFs2PNGInact, 5, 2, XTColorF(1.0f, 0.7f, 0.5f));

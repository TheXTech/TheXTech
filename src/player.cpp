...
//        }
        ...
        else if(Player[A].Dead == false)
        {
            ...
            if(Player[A].Effect == 0)
            {
                ...
                if(Player[A].Slope > 0)
                {
                    if((Player[A].Location.SpeedX > 0 && BlockSlope[Block[Player[A].Slope].Type] == -1) || Player[A].Location.SpeedX < 0 && BlockSlope[Block[Player[A].Slope].Type] == 1)
...
//                                                Netplay::sendData "1q" + std::to_string(A) + LB;
                    ...
                    if(Player[A].Character == 5)
                        C = 0.95F;
                    if(Player[A].Controls.Left == true && (Player[A].Duck == false && Player[A].GrabTime == 0 || (Player[A].Location.SpeedY != 0 && Player[A].StandingOnNPC == 0 && Player[A].Slope == 0) || Player[A].Mount == 1))
                    {
                        Player[A].Bumped = false;
                ...
                else if(Player[A].Wet > 0 && Player[A].Quicksand == 0) // the player is swimming
                {
                    ...
                    if(Player[A].SwimCount == 0)
                    {
                        ...
                        {
                            if(Player[A].Controls.Jump == true && Player[A].CanJump == true || Player[A].Controls.AltJump == true && Player[A].CanAltJump == true)
                            {
                            ...
                            else
                            {
                                ...
                                else if(Player[A].CanFly2 == true)
                                {
                                    if(Player[A].Location.SpeedY > Physics.PlayerJumpVelocity * 0.5)
                                    {
                                        Player[A].Location.SpeedY = Player[A].Location.SpeedY - 1;
                                        Player[A].CanPound = true;
                                        if(Player[A].YoshiBlue == true || Player[A].Mount == 1 && Player[A].MountType == 3)
                                            PlaySound(50);
                                    }
                                }
                            }
...
//                                Netplay::sendData Netplay::PutPlayerLoc(nPlay.MySlot) + "1m" + std::to_string(A) + LB;
                        ...
                        if((Player[A].State == 4 || Player[A].State == 5) || Player[A].YoshiBlue == true || (Player[A].Mount == 1 && Player[A].MountType == 3))
                        {
                            if((Player[A].Controls.Jump == true || Player[A].Controls.AltJump == true) && ((Player[A].Location.SpeedY > Physics.PlayerGravity * 5 && Player[A].Character != 3 && Player[A].Character != 4) || (Player[A].Location.SpeedY > Physics.PlayerGravity * 10 && Player[A].Character == 3) || (Player[A].Location.SpeedY > Physics.PlayerGravity * 7.5 && Player[A].Character == 4)) && Player[A].GroundPound == false && Player[A].Slope == 0 && Player[A].Character != 5)
                            {
                                ...
                                if(!((Player[A].YoshiBlue == false && (Player[A].CanFly == true || Player[A].CanFly2 == true)) || Player[A].Mount == 3 && Player[A].CanFly2 == true))
                                {
                                    if(std::rand() % 10 > 9)
                                    {
                ...
                if(((Player[A].YoshiBlue == false && (Player[A].CanFly == true || Player[A].CanFly2 == true)) || Player[A].Mount == 3 && Player[A].CanFly2 == true) || Player[A].FlySparks == true)
                {
                    if(std::rand() % 4 > 3)
                    {
                        NewEffect(80,
                            ...
                            if(Player[A].Location.Y + Player[A].Location.Height >= Block[B].Location.Y)
                            {
                                if(Player[A].Location.Y <= Block[B].Location.Y + Block[B].Location.Height)
                                {
                                    ...
                                    if(Block[B].Hidden == false)
                                    {
                                        ...
                                        {
                                            if(Player[A].Mount == 2 || (HitSpot == 1 && Player[A].Mount != 0) && !(Block[B].Type == 598))
                                            {
                                            }
                                            else
                                            {
                                        ...
                                        {
                                            HitSpot = 0;
                                            if((Player[A].Mount == 1 || Player[A].Location.SpeedY >= 0 || Player[A].Slide == true || SuperSpeed == true || Player[A].Stoned == true) && (Player[A].Location.Y + Player[A].Location.Height <= Block[B].Location.Y + Block[B].Location.Height + Player[A].Location.SpeedY + 0.001 || Player[A].Slope == 0 && Block[B].Location.SpeedY < 0))
                                            {
                                                if(BlockSlope[Block[B].Type] == 1)
                                                    PlrMid = Player[A].Location.X;
                                                else
                                                ...
                                                else
                                                {
                                                    if(Player[A].Location.Y >= Block[B].Location.Y + (Block[B].Location.Height * Slope) - Player[A].Location.Height - 0.1)
                                                    {
                                                        ...
                                                        if(Block[B].Location.SpeedX != 0 || Block[B].Location.SpeedY != 0)
                                                        {
                                                            ...
                                                            movingBlock = true;
                                                            if((Player[A].Location.SpeedX - NPC[Player[A].StandingOnNPC].Location.SpeedX < 0 && BlockSlope[Block[B].Type]) < 0 || (Player[A].Location.SpeedX - NPC[Player[A].StandingOnNPC].Location.SpeedX > 0 && BlockSlope[Block[B].Type] > 0))
                                                            {
                        ...
                        if(!(Player[A].Mount == 2 && NPC[B].Type == 56) && !(NPC[B].standingOnPlayer == A) && !(NPC[B].Type == 197) && !(NPC[B].Type == 237))
                        {
                            if(NPC[B].HoldingPlayer == 0 || NPCIsABonus[NPC[B].Type] || (BattleMode == true && NPC[B].HoldingPlayer != A))
                            {
                                if(CheckCollision(Player[A].Location, NPC[B].Location) == true)
                                {
                                    ...
                                    if(HitSpot == 1) // Player landed on a NPC
                                    {
                                        ...
                                        else if(!(NPC[B].Type == 22) && !(NPC[B].Type == 31) && !(NPC[B].Type == 49) && !(NPC[B].Type == 50) && (Player[A].SlideKill == false || NPCWontHurt[NPC[B].Type] == true)) // NPCs that cannot be walked on
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if(!(Player[A].WetFrame == true && (NPC[B].Type == 229 || NPC[B].Type == 230) || NPCIsAVine[NPC[B].Type]) && Player[A].HoldingNPC != B)
                                                {
                                                    if(Player[A].Vine > 0)
                                                    {
                                                        Player[A].Vine = 0;
                                    ...
                                    {
                                        // grab code
                                        if((Player[A].CanGrabNPCs == true || NPCIsGrabbable[NPC[B].Type] == true || (NPC[B].Effect == 2 && NPCIsABonus[NPC[B].Type] == false)) && (NPC[B].Effect == 0 || NPC[B].Effect == 2) || (NPCIsAShell[NPC[B].Type] && FreezeNPCs == true)) // GRAB EVERYTHING
                                        {
            ...
            if(CheckCollision(Player[A].Location, Warp[B].Entrance) && Warp[B].Hidden == false)
            {
                ...
                if(canWarp == true)
                {
                    ...
                    if(Warp[B].WarpNPC == false || (Player[A].Mount == 3 && (Player[A].YoshiNPC != 0 || Player[A].YoshiPlayer != 0) && Warp[B].NoYoshi == true))
                    {
                        ...
                        if(Player[A].Character == 3 || Player[A].Character == 4 && Warp[B].Effect == 1 && Warp[B].Direction == 1)
...
void PlayerEffects(int A)
{
    ...
    float D = 0;
    bool tempBool = false;
    Location_t *tempLocation = nullptr;
    ...
    else if(Player[A].Effect == 500) // Change to / from tanooki
    {
            for(B = 1; B <= 2; B++)
            {
                NewEffect 80, newLoc(Player[A].Location.X + Microsoft::VisualBasic::VBMath::Rnd() * (Player[A].Location.Width + 8) - 8, Player[A].Location.Y + Microsoft::VisualBasic::VBMath::Rnd() * (Player[A].Location.Height + 8) - 4),,, ShadowMode;

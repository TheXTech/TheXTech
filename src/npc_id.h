...
enum NPCID
{
    ...
    NPCID_CRAB = 53, NPCID_KANI =NPCID_CRAB,
    NPCID_FLY = 54,
    NPCID_EXTKOOPA = 55,
    NPCID_CLOWNCAR = 56,
    NPCID_CONVEYOR = 57,
    ...
    NPCID_GRNCHEEP = 233,
    NPCID_BONEFISH = 234,
    NPCID_BLOOPER = 235, NPCID_GESO = NPCID_BLOOPER,
    NPCID_SMWCHEEP = 236,
    NPCID_ICEBLOCK = 237,
    ...
    NPCID_POW = 241,
    NPCID_GOOMBA_MISC = 242, NPCID_KURIBO_MISC = NPCID_GOOMBA_MISC,
    ...
    NPCID_PIRANHAHEAD = 270,

    NPCID_SWOOPER = 271, NPCID_BAT = NPCID_SWOOPER, NPCID_BASABASA = NPCID_SWOOPER,
    NPCID_HOOPSTER = 272,
    NPCID_Q_SHROOM = 273,
    NPCID_DRAGONCOIN = 274,
    NPCID_VOLCANO_LOTUS = 275,          NPCID_LAVALOTUS = NPCID_VOLCANO_LOTUS, NPCID_VOLCANO_PLANT = NPCID_VOLCANO_LOTUS, NPCID_PONKI = NPCID_VOLCANO_LOTUS,

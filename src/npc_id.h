...
enum NPCID
{
    ...
    NPCID_GOALORB_SMB3 = 16, NPCID_MAGICBALL = NPCID_GOALORB_SMB3, NPCID_SUISHOU_SMB3 = NPCID_GOALORB_SMB3,
    ...
    NPCID_REDSHYGUY = 20, NPCID_REDHEIHO = NPCID_REDSHYGUY,
    ...
    NPCID_HPIPE_SHORT = 67, NPCID_HDOKAN_SHORT = NPCID_HPIPE_SHORT,
    NPCID_HPIPE_LONG = 68, NPCID_HDOKAN_LONG = NPCID_HPIPE_LONG,
    NPCID_VPIPE_SHORT = 69, NPCID_VDOKAN_SHORT = NPCID_VPIPE_SHORT,
    NPCID_VPIPE_LONG = 70, NPCID_VDOKAN_LONG = NPCID_VPIPE_LONG,

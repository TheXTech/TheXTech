...
{
    NPCID_GOOMBA_SMB3 = 1,
    NPCID_KURIBO_SMB3 = NPCID_GOOMBA_SMB3,
    NPCID_REDGOOMBA = 2,
    NPCID_REDKURIBO = NPCID_REDGOOMBA,
    NPCID_REDPARAGOOMBA = 3,
    NPCID_REDPATAKURIBO = NPCID_REDPARAGOOMBA,
    NPCID_GRNTROOPA_SMB3 = 4,
    NPCID_GRNNOKONOKO_SMB3 = NPCID_GRNTROOPA_SMB3,
    NPCID_GRNSHELL_SMB3 = 5,
    NPCID_GRNKOURA_SMB3 = NPCID_GRNSHELL_SMB3,
    NPCID_REDTROOPA_SMB3 = 6,
    NPCID_REDNOKONOKO_SMB3 = NPCID_REDTROOPA_SMB3,
    NPCID_REDSHELL_SMB3 = 7,
    NPCID_REDKOURA_SMB3 = NPCID_REDSHELL_SMB3,
    NPCID_PIRANHA_SMB3 = 8,
    NPCID_PAKKUNFLOWER_SMB3 = NPCID_PIRANHA_SMB3,
    NPCID_SHROOM_SMB3 = 9,
    NPCID_KINOKO_SMB3 = NPCID_SHROOM_SMB3,
    NPCID_COIN_SMB3 = 10,

    NPCID_ITEMGOAL = 11,
    NPCID_PODOBOO = 12,
    NPCID_LAVABUBBLE = NPCID_PODOBOO,
    NPCID_PLAYERFIREBALL = 13,
    NPCID_FIREFLOWER_SMB3 = 14,
    NPCID_BOOMBOOM = 15, 
    NPCID_BUNBUN = NPCID_BOOMBOOM,
    NPCID_GOALORB_SMB3 = 16, 
    NPCID_MAGICBALL = NPCID_GOALORB_SMB3, NPCID_SUISHOU_SMB3 = NPCID_GOALORB_SMB3,
    NPCID_BULLET_SMB3 = 17, 
    NPCID_KILLER_SMB3 = NPCID_BULLET_SMB3,
    NPCID_BULLET_SMW = 18, 
    NPCID_MAGNUMKILLER_SMW = NPCID_BULLET_SMW,
    NPCID_BLUSHYGUY = 19, 
    NPCID_BLUHEIHO = NPCID_BLUSHYGUY,
    NPCID_REDSHYGUY = 20, 
    NPCID_REDHEIHO = NPCID_REDSHYGUY,

    NPCID_CANNONENEMY = 21,
    NPCID_KILLERHOUDAI = NPCID_CANNONENEMY,
    NPCID_CANNONITEM = 22,
    NPCID_BILLYGUN = NPCID_CANNONITEM,
    NPCID_BUZZYBEETLE = 23,
    NPCID_MET = NPCID_BUZZYBEETLE,
    NPCID_BUZZYSHELL = 24,
    NPCID_METKOURA = NPCID_BUZZYSHELL,
    NPCID_NINJI_SMB2 = 25,
    NPCID_HAKKUN_SMB2 = NPCID_NINJI_SMB2,
    NPCID_SPRING = 26,
    NPCID_TRAMPOLINE = NPCID_SPRING,
    NPCID_UNDERGOOMBA = 27,
    NPCID_CHIKAKURIBO = NPCID_UNDERGOOMBA,
    NPCID_REDCHEEP = 28,
    NPCID_REDPUKU = NPCID_REDCHEEP,
    NPCID_HAMBRO = 29,
    NPCID_HAMMERBRO = NPCID_HAMBRO,
    ...
    NPCID_LEAF = 34,
    NPCID_GRNBOOT = 35,
    NPCID_GRNKUTSU = NPCID_GRNBOOT,
    NPCID_SPINY_SMB3 = 36,
    NPCID_TOGEZO_SMB3 = NPCID_SPINY_SMB3,
    NPCID_THWOMP_SMB3 = 37,
    NPCID_DOSSUN_SMB3 = NPCID_THWOMP_SMB3,
    NPCID_BOO_SMB3 = 38,
    NPCID_TERESA_SMB3 = NPCID_BOO_SMB3,
    NPCID_BIRDO = 39,
    NPCID_CATHERINE = NPCID_BIRDO,
    NPCID_BIRDOEGG = 40,
    NPCID_CATHERINE_TAMAGO = NPCID_BIRDOEGG,

    NPCID_GOALORB_SMB2 = 41,
    NPCID_CRYSTALBALL = NPCID_GOALORB_SMB2,
    NPCID_SUISHOU_SMB2 = NPCID_GOALORB_SMB2,
    NPCID_EERIE = 42,
    NPCID_TELESAULS = NPCID_EERIE,
    NPCID_BOO_SMW = 43,
    NPCID_TERESA_SMW = NPCID_BOO_SMW,
    NPCID_BIGBOO = 44,
    NPCID_DEKATERESA = NPCID_BIGBOO,
    NPCID_ICE_BLOCK = 45,
    NPCID_THROWBLOCK = NPCID_ICE_BLOCK, NPCID_GRABBLOCK = NPCID_ICE_BLOCK, NPC_BURUBURUBLOCK = NPCID_ICE_BLOCK,
    NPCID_DONUTBLOCK_RED = 46,
    NPCID_REDDONUT = NPCID_DONUTBLOCK_RED, NPCID_CHIKUWABLOCK_RED = NPCID_DONUTBLOCK_RED, NPCID_REDCHIKUWA = NPCID_DONUTBLOCK_RED,
    NPCID_LAKITU_SMB3 = 47,
    NPCID_JUGEMU_SMB3 = NPCID_LAKITU_SMB3,
    NPCID_SPINYBALL_SMB3 = 48,
    NPCID_PAIPO_SMB3 = NPCID_SPINYBALL_SMB3,
    NPCID_TOOTHYPIPE = 49,
    NPCID_TOOTHY = 50,

    NPCID_BOTTOMPIRANHA = 51,
    NPCID_BOTTOMPAKKUN = NPCID_BOTTOMPIRANHA,
    NPCID_SIDEPIRANHA = 52,
    NPCID_SIDEPAKKUN = NPCID_SIDEPIRANHA,
    NPCID_CRAB = 53,
    NPCID_SIDESTEPPER = NPCID_CRAB, NPCID_KANI = NPCID_CRAB,
    NPCID_FLY = 54, NPCID_FIGHTERFLY = NPCID_FLY,
    NPCID_EXTKOOPA = 55,
    NPCID_10KOOPA = NPCID_EXTKOOPA,
    NPCID_CLOWNCAR = 56,
    NPCID_CONVEYOR = 57,
    NPCID_CONVEYORBELT = NPCID_CONVEYOR,
    NPCID_METALBARREL = 58,
    NPCID_YELSWITCHGOOMBA = 59,
    NPCID_YELSWITCHKURIBO = NPCID_YELSWITCHGOOMBA,
    NPCID_YELBLOCKS = 60,
    NPCID_YELPLATFORM = NPCID_YELBLOCKS, NPCID_YELLIFT = NPCID_YELBLOCKS,

    NPCID_BLUSWITCHGOOMBA = 61,
    NPCID_BLUSWITCHKURIBO = NPCID_BLUSWITCHGOOMBA,
    NPCID_BLUBLOCKS = 62,
    NPCID_BLUPLATFORM = NPCID_BLUBLOCKS, NPCID_BLULIFT = NPCID_BLUBLOCKS,
    NPCID_GRNSWITCHGOOMBA = 63,
    NPCID_GRNSWITCHKURIBO = NPCID_GRNSWITCHGOOMBA,
    NPCID_GRNBLOCKS = 64,
    NPCID_GRNPLATFORM = NPCID_GRNBLOCKS, NPCID_GRNLIFT = NPCID_GRNBLOCKS,
    NPCID_REDSWITCHGOOMBA = 65,
    NPCID_REDSWITCHKURIBO = NPCID_REDSWITCHGOOMBA,
    NPCID_REDBLOCKS = 66,
    NPCID_REDPLATFORM = NPCID_REDBLOCKS, NPCID_REDLIFT = NPCID_REDBLOCKS,
    NPCID_HPIPE_SHORT = 67,
    NPCID_HDOKAN_SHORT = NPCID_HPIPE_SHORT,
    NPCID_HPIPE_LONG = 68,
    NPCID_HDOKAN_LONG = NPCID_HPIPE_LONG,
    NPCID_VPIPE_SHORT = 69,
    NPCID_VDOKAN_SHORT = NPCID_VPIPE_SHORT,
    NPCID_VPIPE_LONG = 70,
    NPCID_VDOKAN_LONG = NPCID_VPIPE_LONG,

    NPCID_BIGGOOMBA = 71,
    NPCID_DEKAKURIBO = NPCID_BIGGOOMBA,
    NPCID_BIGTROOPA = 72,
    NPCID_DEKANOKONOKO = NPCID_BIGTROOPA,
    NPCID_BIGSHELL = 73,
    NPCID_DEKAKOURA = NPCID_BIGSHELL,
    NPCID_BIGPIRANHA = 74,
    NPCID_DEKAPAKKUN = NPCID_BIGPIRANHA,
    NPCID_TOAD_A = 75,
    NPCID_KINOPIO_A = NPCID_TOAD_A,
    NPCID_GRNPARA_SMB3 = 76,
    NPCID_GRNPATAPATA_SMB3 = NPCID_GRNPARA_SMB3,
    NPCID_NINJI_SMW = 77,
    NPCID_HAKKUN_SMW = NPCID_NINJI_SMW,
    NPCID_TANKTREADS = 78,
    NPCID_SHORTWOOD = 79,
    NPCID_LONGWOOD = 80,
    ...
    NPCID_KOOPASEKIZOU_SMB3 = NPCID_STATUE_SMB3,
    NPCID_EXT_FIRE_B = 85,
    NPCID_BOWSER_SMB3 = 86,
    NPCID_KOOPA3 = NPCID_BOWSER_SMB3,
    NPCID_EXT_FIRE_A = 87,
    NPCID_COIN_SMB = 88,
    NPCID_GOOMBA_SMB = 89,
    NPCID_KURIBO_SMB = NPCID_GOOMBA_SMB,
    NPCID_LIFE_SMB3 = 90,
    ...
    NPCID_PINKBOBOMB = 107, NPCID_PINKBOMBHEI = NPCID_PINKBOBOMB,
    NPCID_YOSHIFIRE = 108,
    ...
    NPCID_ACTIVEBOBOMB_SMB3 = 137, NPCID_ACTIVEBOMBHEI_SMB3 = NPCID_ACTIVEBOBOMB_SMB3,
    NPCID_COIN_SMB2 = 138,
    ...
    NPCID_PSHROOM = 153, NPCID_DOKUKINOKO = NPCID_PSHROOM,
    NPCID_SHROOMBLOCK_A = 154, NPCID_KINOKOBLOCK_A = NPCID_SHROOMBLOCK_A,
    NPCID_SHROOMBLOCK_B = 155, NPCID_KINOKOBLOCK_B = NPCID_SHROOMBLOCK_B,
    NPCID_SHROOMBLOCK_C = 156, NPCID_KINOKOBLOCK_C = NPCID_SHROOMBLOCK_C,
    NPCID_SHROOMBLOCK_D = 157, NPCID_KINOKOBLOCK_D = NPCID_SHROOMBLOCK_D,
    NPCID_SATURN = 158, NPCID_MRSATURN = NPCID_SATURN,
    NPCID_DOSEISAN = NPCID_SATURN,
    NPCID_QUICKSAND = 159, NPCID_SOFTSAND = NPCID_QUICKSAND, NPCID_SUNA = NPCID_QUICKSAND,
    ...
    NPCID_AXE = 178,
    NPCID_SAW = 179, NPCID_GRINDER = NPCID_SAW, NPCID_GARIGARI = NPCID_SAW,
    ...
    NPCID_CHECKPOINT = 192, NPCID_CHUKANGATE = NPCID_CHECKPOINT,
    ...
    NPCID_STAR_SMW = 196,
    NPCID_GOALTAPE = 197, NPCID_GOALGATE = NPCID_GOALTAPE, NPCID_GIANTGATE = NPCID_GOALTAPE,
    NPCID_PRINCESS = 198,
    ...
    NPCID_METROID_GIMMER = NPCID_METROID_ZOOMER,
    NPCID_SPARK = 206, NPCID_KESERAN = NPCID_SPARK,
    ...
    NPCID_RINKAGEN = 211,
    NPCID_DONUTBLOCK_BROWN = 212,       NPCID_BLUDONUT = NPCID_DONUTBLOCK_BROWN, NPCID_CHIKUWABLOCK_BROWN = NPCID_DONUTBLOCK_BROWN, NPCID_BLUCHIKUWA = NPCID_DONUTBLOCK_BROWN, 
    ...
    NPCID_LADDER = 221, NPCID_HASHIGO = NPCID_LADDER,
    ...
    NPCID_VINEHEAD_RED_SMB3 = 225, NPCID_REDVINETOP_SMB3 = NPCID_VINEHEAD_RED_SMB3, NPCID_TSURUHEAD_RED_SMB3 = NPCID_VINEHEAD_RED_SMB3, NPCID_REDTSURUTOP_SMB3 = NPCID_VINEHEAD_RED_SMB3,
    NPCID_VINEHEAD_GREEN_SMB3 = 226, NPCID_GRNVINETOP_SMB3 = NPCID_VINEHEAD_GREEN_SMB3, NPCID_TSURUHEAD_GREEN_SMB3 = NPCID_VINEHEAD_GREEN_SMB3, NPCID_GRNTSURUTOP_SMB3 = NPCID_VINEHEAD_GREEN_SMB3,
    NPCID_VINEHEAD_SMW = 227, NPCID_GRNVINETOP_SMW = NPCID_VINEHEAD_SMW, NPCID_TSURUHEAD_SMW = NPCID_VINEHEAD_SMW, NPCID_GRNTSURUTOP_SMW = NPCID_VINEHEAD_SMW,
    ...
    NPCID_TIMER_SMB2 = 240, NPCID_STOPWATCH_SMB2 = NPCID_TIMER_SMB2,

    NPCID_POW = 241,
    NPCID_GOOMBA_MISC = 242,
    NPCID_GOOMBA_SML2 = NPCID_GOOMBA_MISC, NPCID_KURIBO_MISC = NPCID_GOOMBA_MISC, NPCID_KURIBO_SML2 = NPCID_GOOMBA_MISC,
    NPCID_PARAGOOMBA_MISC = 243,
    NPCID_PARAGOOMBA_SML2 = NPCID_PARAGOOMBA_MISC, NPCID_PATAKURIBO_MISC = NPCID_PARAGOOMBA_MISC, NPCID_PATAKURIBO_SML2 = NPCID_PARAGOOMBA_MISC,
    NPCID_PARAGOOMBA_SMB3 = 244,
    NPCID_PATAKURIBO_SMB3 = NPCID_PARAGOOMBA_SMB3,
    NPCID_FIREPIRANHA = 245,
    NPCID_FIREPAKKUN = NPCID_FIREPIRANHA,
    NPCID_EXT_FIRE_D = 246,
    NPCID_POKEY = 247,
    NPCID_SAMBO = NPCID_POKEY,
    NPCID_TIMER_SMB3 = 248,
    NPCID_STOPWATCH_SMB3 = NPCID_TIMER_SMB3,
    NPCID_SHROOM_SMB2 = 249,
    NPCID_KINOKO_SMB2 = NPCID_SHROOM_SMB2,
    NPCID_HEART = 250,
    ...
    NPCID_LOCKDOOR = 255,
    NPCID_LONGPIRANHA_UP = 256,
    NPCID_LONGPAKKUN_UP = NPCID_LONGPIRANHA_UP,
    NPCID_LONGPIRANHA_DOWN = 257,
    NPCID_LONGPAKKUN_DOWN = NPCID_LONGPIRANHA_DOWN,
    NPCID_BLUECOIN = 258,
    NPCID_ROTODISK = 259, NPCID_COOKIE = NPCID_ROTODISK,
    NPCID_FIREBAR = 260,

    NPCID_NIPPER_PLANT = 261, NPCID_MUNCHER = NPCID_NIPPER_PLANT,
    NPCID_PUCHIPAKKUN = NPCID_NIPPER_PLANT,
    NPCID_MOUSER = 262,
    NPCID_DON_CHURUGE = NPCID_MOUSER,
    ...
    NPCID_PIRANHAHEAD = 270, NPCID_JUMPINGPIRANHA = NPCID_PIRANHAHEAD,
    NPCID_PAKKUNHEAD = NPCID_PIRANHAHEAD,
    NPCID_P_PAKKUN = NPCID_PIRANHAHEAD, 

    NPCID_SWOOPER = 271, NPCID_BAT = NPCID_SWOOPER, NPCID_SWOOP = NPCID_SWOOPER,
    NPCID_BASABASA = NPCID_SWOOPER,
    NPCID_HOOPSTER = 272,
    NPCID_TAPEN = NPCID_HOOPSTER,
    NPCID_Q_SHROOM = 273, NPCID_SWAP_SHROOM = NPCID_Q_SHROOM,
    NPCID_KOUKAN_KINOKO = NPCID_Q_SHROOM,
    NPCID_DRAGONCOIN = 274, NPCID_YOSHICOIN = NPCID_DRAGONCOIN,
    NPCID_VOLCANO_LOTUS = 275,          NPCID_LAVALOTUS = NPCID_VOLCANO_LOTUS,
    NPCID_VOLCANO_PLANT = NPCID_VOLCANO_LOTUS, NPCID_PONKI = NPCID_VOLCANO_LOTUS,
    ...
    NPCID_LUDWIG_SHELL = 281,
    NPCID_LUDWIGSHELL = NPCID_LUDWIG_SHELL,
    NPCID_LUDWIG_FIRE = 282,
    NPCID_EXT_FIRE_C = NPCID_LUDWIG_FIRE,
    NPCID_BUBBLE = 283,
    NPCID_LAKITU_SMW = 284,
    NPCID_JUGEMU_SMW = NPCID_LAKITU_SMW,
    NPCID_SPINY_SMW = 285,
    NPCID_TOGEZO_SMW = NPCID_SPINY_SMW,
    NPCID_SPINYEGG_SMW = 286,
    NPCID_SPINYBALL_SMW = NPCID_SPINYEGG_SMW, NPCID_PAIPO_SMW = NPCID_SPINYEGG_SMW,
    NPCID_RANDOM_POWERUP = 287,
    NPCID_POTION = 288,
    NPCID_MAHOU_NO_KUSURI = NPCID_POTION,
    NPCID_POTIONDOOR = 289,
    NPCID_MAHOUDOOR = NPCID_POTIONDOOR,
    NPCID_COCKPIT = 290,

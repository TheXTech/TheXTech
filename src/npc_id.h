...
enum NPCID
{
    ...
    NPCID_GOALORB_SMB2 = 41, NPCID_CRYSTALBALL = NPCID_GOALORB_SMB2, NPCID_SUISHOU_SMB2 = NPCID_GOALORB_SMB2,
    ...
    NPCID_ICE_BLOCK = 45,       NPCID_THROWBLOCK = NPCID_ICE_BLOCK, NPCID_GRABBLOCK = NPCID_ICE_BLOCK, NPC_BURUBURUBLOCK = NPCID_ICE_BLOCK,
    NPCID_DONUTBLOCK_RED = 46,  NPCID_REDDONUT = NPCID_DONUTBLOCK_RED, NPCID_CHIKUWABLOCK_RED = NPCID_DONUTBLOCK_RED, NPCID_REDCHIKUWA = NPCID_DONUTBLOCK_RED,
    ...
    NPCID_CRAB = 53, NPCID_SIDESTEPPER = NPCID_CRAB,
    NPCID_KANI = NPCID_CRAB,
    ...
    NPCID_YELBLOCKS = 60, NPCID_YELPLATFORM = NPCID_YELBLOCKS,
    NPCID_YELLIFT = NPCID_YELBLOCKS,

    NPCID_BLUSWITCHGOOMBA = 61,
    NPCID_BLUSWITCHKURIBO = NPCID_BLUSWITCHGOOMBA,
    NPCID_BLUBLOCKS = 62, NPCID_BLUPLATFORM = NPCID_BLUBLOCKS,
    NPCID_BLULIFT = NPCID_BLUBLOCKS,
    NPCID_GRNSWITCHGOOMBA = 63,
    NPCID_GRNSWITCHKURIBO = NPCID_GRNSWITCHGOOMBA,
    NPCID_GRNBLOCKS = 64, NPCID_GRNPLATFORM = NPCID_GRNBLOCKS,
    NPCID_GRNLIFT = NPCID_GRNBLOCKS,
    NPCID_REDSWITCHGOOMBA = 65,
    NPCID_REDSWITCHKURIBO = NPCID_REDSWITCHGOOMBA,
    NPCID_REDBLOCKS = 66, NPCID_REDPLATFORM = NPCID_REDBLOCKS,
    NPCID_REDLIFT = NPCID_REDBLOCKS,

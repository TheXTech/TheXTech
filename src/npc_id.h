...
enum NPCID
{
    ...
    NPCID_MOON = 188,
    NPCID_DRYBONES = 189,
    NPCID_SKULL = 190, NPCID_SKULLRAFT = NPCID_SKULL,

    NPCID_REDBOOT = 191,
    NPCID_CHECKPOINT = 192,
    NPCID_BLUBOOT = 193,
    NPCID_DISCOSHELL = 194, NPCID_RAINBOWSHELL = NPCID_DISCOSHELL,
    NPCID_FLIPPEDDISCO = 195, NPCID_FLIPPEDRAINBOWSHELL = NPCID_FLIPPEDDISCO, NPCID_UPSIDEDOWNRAINBOWSHELL = NPCID_FLIPPEDDISCO,
    NPCID_STAR_SMW = 196,
    NPCID_GOALTAPE = 197,
    NPCID_PRINCESS = 198,
    NPCID_BLARGG = 199,
    ...
    NPCID_GOGGLEFISH = 232, NPCID_BLURP = NPCID_GOGGLEFISH,
    NPCID_GRNCHEEP = 233,
    NPCID_BONEFISH = 234, NPCID_FISHBONE = NPCID_BONEFISH,
    NPCID_BLOOPER = 235, NPCID_BLOOPER_SMB = NPCID_BLOOPER,
    NPCID_SMWCHEEP = 236,
    NPCID_ICEBLOCK = 237,
    ...
    NPCID_POW = 241,
    NPCID_GOOMBA_MISC = 242, NPCID_GOOMBA_SML2 = NPCID_GOOMBA_MISC,
    NPCID_PARAGOOMBA_MISC = 243, NPCID_PARAGOOMBA_SML2 = NPCID_PARAGOOMBA_MISC,

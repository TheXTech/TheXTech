...
extern void InitIfMissing(std::map<std::string, double>* pMap, std::string sought_key, double init_val);

extern bool FastTestCollision(int Left1, int Up1, int Right1, int Down1, int Left2, int Up2, int Right2, int Down2);

extern int ComputeLevelSection(int x, int y);			// Compute the current SMBX level section for the given coords, or -1 if invalid

...
static void write_NPCs()
{
    ...
    for(int i = 1; i <= numNPCs; i++)
    {
        ...
        fprintf(record_file, "S %lf %lf %lf %lf %lf %lf %lf\r\n", n.Special, (double)n.Special2, (double)n.Special3, (double)n.Special4, (double)n.Special5, (double)n.Special6, (double)n.Variant);
    }
}
...
static void read_NPCs()
{
    ...
    if(success)
    {
        for(int i = 1; i <= o_numNPCs; i++)
        {
            ...
            double sNew[] = {n.Special, (double)n.Special2, (double)n.Special3, (double)n.Special4, (double)n.Special5, (double)n.Special6, (double)n.Variant};

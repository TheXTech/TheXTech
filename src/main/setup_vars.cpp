...
void SetupVars()
{
    ...
    // {
    //     NPCTraits[A].Score = 2;
    //     NPCTraits[A].Width = 32;
    //     NPCTraits[A].Height = 32;
    // }

    NPCTraits[291].Width = 22;
    NPCTraits[291].Height = 18;
    ...
    NPCTraits[289].Width = 32;
    NPCTraits[289].Height = 32;
    NPCTraits[289].WidthGFX = 32;
    NPCTraits[289].HeightGFX = 64;


    NPCTraits[283].Width = 48;
    NPCTraits[283].Height = 48;
    ...
    NPCTraits[262].Width = 40;
    NPCTraits[262].Height = 56;
    ...
    NPCTraits[246].Width = 16;
    NPCTraits[246].Height = 16;

    NPCTraits[251].Width = 18; // TLOZ Rupee
    NPCTraits[251].Height = 32;
    // NPCIsABonus(251) = true;
    // NPCIsACoin(251) = true;

    NPCTraits[252].Width = 18; // TLOZ Rupee
    NPCTraits[252].Height = 32;
    // NPCIsABonus(252) = true;
    // NPCIsACoin(252) = true;

    NPCTraits[253].Width = 18; // TLOZ Rupee
    NPCTraits[253].Height = 32;
    // NPCIsABonus(253) = true;
    // NPCIsACoin(253) = true;

    NPCTraits[250].Width = 32; // TLOZ Heart
    NPCTraits[250].Height = 32;
    ...
    NPCTraits[240].Width = 32;
    NPCTraits[240].Height = 32;
    // NPCIsABonus(240) = true;//32;

    NPCTraits[248].Width = 32;
    NPCTraits[248].Height = 32;
    // NPCIsABonus(248) = true;//32;

    NPCTraits[200].Width = 64;
    NPCTraits[200].Height = 72;
    ...
    NPCTraits[260].Width = 16;
    NPCTraits[260].Height = 16;
    NPCTraits[260].NoClipping = true;

    NPCTraits[153].Width = 32; // Poison Mushroom
    NPCTraits[153].Height = 32;
    NPCTraits[153].FrameOffsetY = 2;

    NPCTraits[242].Width = 32; // SML2 Goomba
    NPCTraits[242].Height = 32;
    NPCTraits[242].FrameOffsetY = 2;
    // NPCDefaultMovement(242) = true;

    NPCTraits[243].Width = 32; // SML2 Flying Goomba
    NPCTraits[243].Height = 32;
    NPCTraits[243].FrameOffsetY = 2;
    NPCTraits[243].WidthGFX = 56;
    NPCTraits[243].HeightGFX = 36;

    NPCTraits[244].Width = 32; // SMB3 Flying Goomba
    NPCTraits[244].Height = 32;
    NPCTraits[244].FrameOffsetY = 2;
    NPCTraits[244].WidthGFX = 40;
    NPCTraits[244].HeightGFX = 48;

    NPCTraits[255].Width = 20;
    NPCTraits[255].Height = 96;
    ...
    NPCTraits[1].Width = 32; // Goomba
    NPCTraits[1].Height = 32;
    NPCTraits[1].FrameOffsetY = 2;

    NPCTraits[1].Width = 32; // Goomba
    NPCTraits[1].Height = 32;
    NPCTraits[1].FrameOffsetY = 2;
    NPCTraits[2].Width = 32; // Red goomba
    NPCTraits[2].Height = 32;
    NPCTraits[2].FrameOffsetY = 2;
    NPCTraits[3].Width = 32; // Flying goomba
    NPCTraits[3].Height = 32;
    NPCTraits[3].WidthGFX = 40;
    NPCTraits[3].HeightGFX = 48;
    NPCTraits[3].FrameOffsetY = 2;
    NPCTraits[4].Width = 32; // Green koopa
    NPCTraits[4].Height = 32;
    NPCTraits[4].WidthGFX = 32;
    NPCTraits[4].HeightGFX = 54;
    NPCTraits[4].FrameOffsetY = 2;
    NPCTraits[5].Width = 32; // Green shell
    NPCTraits[5].Height = 32;
    NPCTraits[5].FrameOffsetY = 2;
    NPCTraits[6].Width = 32; // Red koopa
    NPCTraits[6].Height = 32;
    NPCTraits[6].WidthGFX = 32;
    NPCTraits[6].HeightGFX = 54;
    NPCTraits[6].FrameOffsetY = 2;
    NPCTraits[7].Width = 32; // Red shell
    NPCTraits[7].Height = 32;
    NPCTraits[7].FrameOffsetY = 2;
    NPCTraits[8].Width = 32; // Plant
    NPCTraits[8].Height = 48;
    NPCTraits[8].WidthGFX = 32;
    NPCTraits[8].HeightGFX = 48;
    NPCTraits[245].Width = 32; // SMB 3 Fire Plant
    NPCTraits[245].Height = 64;
    NPCTraits[245].WidthGFX = 32;
    NPCTraits[245].HeightGFX = 64;
    NPCTraits[8].FrameOffsetY = 1;
    NPCTraits[9].Width = 32; // Mushroom
    NPCTraits[9].Height = 32;
    ...
    NPCTraits[273].Width = 32; // ? Mushroom
    NPCTraits[273].Height = 32;
    NPCTraits[273].FrameOffsetY = 2;

    NPCTraits[249].Width = 32; // SMB2 Mushroom
    NPCTraits[249].Height = 32;
    // NPCIsABonus(249) = true;

    NPCTraits[274].Width = 32; // dragon coin
    NPCTraits[274].Height = 50;
    // NPCIsABonus(274) = true;
    // NPCIsACoin(274) = true;
    NPCTraits[274].Score = 6;

    NPCTraits[10].Width = 28; // SMB3 Coin
    NPCTraits[10].Height = 32;
    NPCTraits[11].Width = 32; // SMB3 Level exit
    NPCTraits[11].Height = 32;
    NPCTraits[12].Width = 28; // Big Fireball
    NPCTraits[12].Height = 32;
    NPCTraits[13].Width = 16; // Small Fireball
    NPCTraits[13].Height = 16;
    NPCTraits[265].Width = 16; // Ice Bolt
    NPCTraits[265].Height = 16;
    NPCTraits[265].NoIceBall = true;
    NPCTraits[13].NoYoshi = true;
    NPCTraits[14].Width = 32; // Fire Flower
    NPCTraits[14].Height = 32;
    NPCTraits[14].FrameOffsetY = 2;
    NPCTraits[264].Width = 32; // Ice Flower
    NPCTraits[264].Height = 32;
    NPCTraits[264].FrameOffsetY = 2;
    NPCTraits[277].Width = 32; // Ice Flower
    NPCTraits[277].Height = 32;
    NPCTraits[277].FrameOffsetY = 2;
    NPCTraits[15].Width = 60; // Big Koopa
    NPCTraits[15].Height = 54;
    NPCTraits[15].WidthGFX = 68;
    NPCTraits[15].HeightGFX = 54;
    NPCTraits[15].FrameOffsetY = 2;
    NPCTraits[15].NoYoshi = true;
    NPCTraits[16].Width = 32; // Boss Exit
    NPCTraits[16].Height = 32;
    NPCTraits[17].Width = 32; // Bullet Bill
    NPCTraits[17].Height = 28;
    NPCTraits[18].Width = 128; // Giant Bullet Bill
    NPCTraits[18].Height = 128;
    NPCTraits[18].NoYoshi = true;
    NPCTraits[19].Width = 32; // Red Shy guy
    NPCTraits[19].Height = 32;
    NPCTraits[20].Width = 32; // Blue Shy guy
    NPCTraits[20].Height = 32;
    NPCTraits[247].Width = 32; // Cactus Thing
    NPCTraits[247].Height = 32;
    NPCTraits[21].Width = 32; // Bullet Bill Shooter
    NPCTraits[21].Height = 32;
    NPCTraits[21].NoYoshi = true;
    NPCTraits[22].Width = 32; // Bullet Bill Gun
    NPCTraits[22].Height = 32;
    NPCTraits[22].FrameOffsetY = 2;
    NPCTraits[23].Width = 32; // Hard thing
    NPCTraits[23].Height = 32;
    NPCTraits[23].FrameOffsetY = 2;
    NPCTraits[24].Width = 32; // Hard Thing shell
    NPCTraits[24].Height = 32;
    NPCTraits[24].FrameOffsetY = 2;
    NPCTraits[25].Width = 32; // Bouncy Start Thing
    NPCTraits[25].Height = 32;
    NPCTraits[26].Width = 32; // Spring
    NPCTraits[26].Height = 32;
    NPCTraits[26].WidthGFX = 32;
    NPCTraits[26].HeightGFX = 32;
    NPCTraits[26].FrameOffsetY = 2;
    NPCTraits[27].Width = 32; // Grey goomba
    NPCTraits[27].Height = 32;
    NPCTraits[28].Width = 32; // Red Jumping Fish
    NPCTraits[28].Height = 32;
    NPCTraits[29].Width = 32; // Hammer Bro
    NPCTraits[29].Height = 48;
    NPCTraits[29].FrameOffsetY = 2;
    NPCTraits[30].Width = 32; // Hammer
    NPCTraits[30].Height = 32;
    NPCTraits[30].NoYoshi = true;
    NPCTraits[31].Width = 32; // Key
    NPCTraits[31].Height = 32;
    NPCTraits[31].FrameOffsetY = 1;
    NPCTraits[32].Width = 32; // P Switch
    NPCTraits[32].Height = 32;
    NPCTraits[32].FrameOffsetY = 2;
    NPCTraits[238].Width = 32; // P Switch Time
    NPCTraits[238].Height = 32;
    NPCTraits[238].FrameOffsetY = 2;
    NPCTraits[239].Width = 32; // Push down thing
    NPCTraits[239].Height = 32;
    NPCTraits[239].FrameOffsetY = 2;
    NPCTraits[33].Width = 24; // SMW Coin
    NPCTraits[33].Height = 32;
    NPCTraits[258].Width = 24; // SMW Blue Coin
    NPCTraits[258].Height = 32;
    NPCTraits[34].Width = 32; // Leaf
    NPCTraits[34].Height = 32;
    NPCTraits[35].Width = 32; // Goombas Shoe
    NPCTraits[35].Height = 32;
    NPCTraits[35].FrameOffsetY = 2;
    NPCTraits[191].FrameOffsetY = 2;
    NPCTraits[193].FrameOffsetY = 2;

    NPCTraits[285].Width = 32; // Spiney
    NPCTraits[285].Height = 32;
    NPCTraits[285].FrameOffsetY = 2;
    NPCTraits[286].Width = 32; // Falling Spiney
    NPCTraits[286].Height = 32;
    NPCTraits[286].FrameOffsetY = 2;

    NPCTraits[36].Width = 32; // Spiney
    NPCTraits[36].Height = 32;
    NPCTraits[36].FrameOffsetY = 2;
    NPCTraits[37].Width = 48; // Thwomp
    NPCTraits[37].Height = 64;
    NPCTraits[37].NoYoshi = true;
    NPCTraits[38].Width = 32; // Boo
    NPCTraits[38].Height = 32;
    NPCTraits[38].NoYoshi = true;
    NPCTraits[39].Width = 32; // Birdo
    NPCTraits[39].Height = 60;
    ...
    NPCTraits[40].Width = 32; // egg
    NPCTraits[40].Height = 24;
    NPCTraits[41].Width = 32; // smb2 exit(birdo)
    NPCTraits[41].Height = 32;
    NPCTraits[42].Width = 32; // ghost 1
    NPCTraits[42].Height = 32;
    NPCTraits[42].NoYoshi = true;
    NPCTraits[43].Width = 32; // ghost 2
    NPCTraits[43].Height = 32;
    NPCTraits[43].NoYoshi = true;
    NPCTraits[44].Width = 128; // big ghost
    NPCTraits[44].Height = 120;
    NPCTraits[44].WidthGFX = 140;
    NPCTraits[44].HeightGFX = 128;
    NPCTraits[44].NoYoshi = true;
    NPCTraits[45].Width = 32; // ice block
    NPCTraits[45].Height = 32;
    NPCTraits[46].Width = 32; // falling block
    NPCTraits[46].Height = 32;
    NPCTraits[46].NoYoshi = true;
    NPCTraits[212].NoYoshi = true;
    NPCTraits[47].Width = 32; // lakitu
    NPCTraits[47].Height = 48;
    NPCTraits[47].WidthGFX = 32;
    NPCTraits[47].HeightGFX = 64;
    NPCTraits[284].Width = 40; // smw lakitu
    NPCTraits[284].Height = 48;
    NPCTraits[284].FrameOffsetY = 6;
    NPCTraits[284].WidthGFX = 56;
    NPCTraits[284].HeightGFX = 72;

    NPCTraits[48].Width = 32; // unripe spiney
    NPCTraits[48].Height = 32;
    NPCTraits[49].Width = 32; // killer pipe
    NPCTraits[49].Height = 32;
    NPCTraits[49].FrameOffsetY = 2;
    NPCTraits[50].Width = 48; // killer plant
    NPCTraits[50].Height = 32;
    NPCTraits[50].FrameOffsetY = 2;
    NPCTraits[50].NoYoshi = true;
    NPCTraits[51].Width = 32; // down piranha plant
    NPCTraits[51].Height = 64;
    NPCTraits[52].Width = 48; // left.right piranha plant
    NPCTraits[52].Height = 32;
    NPCTraits[53].Width = 32; // mr crabs
    NPCTraits[53].Height = 32;
    NPCTraits[53].FrameOffsetY = 2;
    NPCTraits[54].Width = 32; // bee thing
    NPCTraits[54].Height = 32;
    NPCTraits[54].FrameOffsetY = 2;
    NPCTraits[55].Width = 32; // nekkid koopa
    NPCTraits[55].Height = 32;
    NPCTraits[55].FrameOffsetY = 2;
    NPCTraits[56].Width = 128; // koopa clown car
    NPCTraits[56].Height = 128;
    NPCTraits[56].NoYoshi = true;
    NPCTraits[57].Width = 32; // smb3 conveyer belt
    NPCTraits[57].Height = 32;
    NPCTraits[57].NoYoshi = true;
    NPCTraits[58].Width = 32; // smb3 barrel
    NPCTraits[58].Height = 32;
    NPCTraits[58].NoYoshi = true;
    NPCTraits[59].Width = 32; // purple goomba
    NPCTraits[59].Height = 32;
    NPCTraits[59].FrameOffsetY = 2;
    NPCTraits[60].Width = 96; // purple platform
    NPCTraits[60].Height = 32;
    NPCTraits[60].NoYoshi = true;
    NPCTraits[61].Width = 32; // blue goomba
    NPCTraits[61].Height = 32;
    NPCTraits[61].FrameOffsetY = 2;
    NPCTraits[62].Width = 96; // blue platform
    NPCTraits[62].Height = 32;
    NPCTraits[62].NoYoshi = true;
    NPCTraits[63].Width = 32; // green goomba
    NPCTraits[63].Height = 32;
    NPCTraits[63].FrameOffsetY = 2;
    NPCTraits[64].Width = 96; // green platform
    NPCTraits[64].Height = 32;
    NPCTraits[64].NoYoshi = true;
    NPCTraits[65].Width = 32; // red goomba
    NPCTraits[65].Height = 32;
    NPCTraits[65].FrameOffsetY = 2;
    NPCTraits[66].Width = 96; // red platform
    NPCTraits[66].Height = 32;
    NPCTraits[66].NoYoshi = true;
    NPCTraits[67].Width = 128; // grey pipe x
    NPCTraits[67].Height = 32;
    NPCTraits[67].NoYoshi = true;
    NPCTraits[68].Width = 256; // big grey pipe x
    NPCTraits[68].Height = 32;
    NPCTraits[68].NoYoshi = true;
    NPCTraits[69].Width = 32; // grey pipe y
    NPCTraits[69].Height = 127;//.9; [IDK WY REDIGIT SET THESE!!!]
    NPCTraits[69].NoYoshi = true;
    NPCTraits[70].Width = 32; // big grey pipe y
    NPCTraits[70].Height = 255;//.9;
    NPCTraits[70].NoYoshi = true;
    NPCTraits[71].Width = 48; // giant goomba
    NPCTraits[71].Height = 46;
    NPCTraits[71].FrameOffsetY = 2;
    NPCTraits[72].Width = 48; // giant green koopa
    NPCTraits[72].Height = 48;
    NPCTraits[72].FrameOffsetY = 2;
    NPCTraits[72].WidthGFX = 48;
    NPCTraits[72].HeightGFX = 62;
    NPCTraits[73].Width = 44; // giant green shell
    NPCTraits[73].Height = 44;
    NPCTraits[73].FrameOffsetY = 2;
    NPCTraits[74].Width = 48; // giant pirhana plant
    NPCTraits[74].Height = 64;
    NPCTraits[74].FrameOffsetY = 2;

    NPCTraits[256].Width = 48; // gianter pirhana plant
    NPCTraits[256].Height = 128;
    NPCTraits[256].FrameOffsetY = 2;

    NPCTraits[257].Width = 48; // gianter pirhana plant
    NPCTraits[257].Height = 128;

    NPCTraits[75].Width = 38; // toad
    NPCTraits[75].Height = 54;
    NPCTraits[75].FrameOffsetY = 2;
    NPCTraits[75].WidthGFX = 38;
    NPCTraits[75].HeightGFX = 58;
    // NPCIsToad(75) = true;
    NPCTraits[76].Width = 32; // flying green koopa
    NPCTraits[76].Height = 32;
    NPCTraits[76].FrameOffsetY = 2;
    NPCTraits[76].WidthGFX = 32;
    NPCTraits[76].HeightGFX = 56;
    // NPCIsAParaTroopa(76) = true;
    NPCTraits[161].Width = 32; // flying red koopa
    NPCTraits[161].Height = 32;
    NPCTraits[161].FrameOffsetY = 2;
    NPCTraits[161].WidthGFX = 32;
    NPCTraits[161].HeightGFX = 56;
    // NPCIsAParaTroopa(161) = true;
    NPCTraits[77].Width = 32; // black ninja
    NPCTraits[77].Height = 32;
    NPCTraits[73].FrameOffsetY = 2;
    NPCTraits[78].Width = 128; // tank treads
    NPCTraits[78].Height = 32;
    NPCTraits[78].NoYoshi = true;
    NPCTraits[79].Width = 64; // tank parts
    NPCTraits[79].Height = 32;
    NPCTraits[79].NoYoshi = true;
    NPCTraits[80].Width = 128; // tank parts
    NPCTraits[80].Height = 32;
    NPCTraits[80].NoYoshi = true;
    NPCTraits[81].Width = 128; // tank parts
    NPCTraits[81].Height = 32;
    NPCTraits[81].NoYoshi = true;
    NPCTraits[82].Width = 128; // tank parts
    NPCTraits[82].Height = 32;
    NPCTraits[82].NoYoshi = true;
    NPCTraits[83].Width = 256; // tank parts
    NPCTraits[83].Height = 32;
    NPCTraits[83].NoYoshi = true;
    NPCTraits[84].Width = 32; // bowser statue
    NPCTraits[84].Height = 64;
    NPCTraits[84].NoYoshi = true;
    NPCTraits[85].Width = 32; // statue fireball
    NPCTraits[85].Height = 16;
    NPCTraits[85].NoYoshi = true;
    NPCTraits[86].Width = 62; // smb3 bowser
    NPCTraits[86].Height = 80;
    NPCTraits[86].WidthGFX = 64;
    NPCTraits[86].HeightGFX = 80;
    NPCTraits[86].FrameOffsetY = 2;
    NPCTraits[86].NoYoshi = true;
    NPCTraits[87].Width = 48; // smb3 bowser fireball
    NPCTraits[87].Height = 32;
    NPCTraits[87].NoYoshi = true;
    NPCTraits[88].Width = 20; // smb1 coin
    NPCTraits[88].Height = 32;
    NPCTraits[89].Width = 32; // smb1 brown goomba
    NPCTraits[89].Height = 32;
    NPCTraits[89].FrameOffsetY = 2;
    NPCTraits[90].Width = 32; // 1 up
    NPCTraits[90].Height = 32;
    NPCTraits[90].FrameOffsetY = 2;
    NPCTraits[90].IsAHit1Block = true;
    NPCTraits[91].Width = 32; // grab grass
    NPCTraits[91].Height = 16;
    NPCTraits[91].FrameOffsetY = -16;
    NPCTraits[92].Width = 32; // turnip
    NPCTraits[92].Height = 32;
    // NPCIsVeggie(92) = true;
    NPCTraits[93].Width = 32; // SMB1 Plant
    NPCTraits[93].Height = 48;
    NPCTraits[94].Width = 32; // Inert Toad
    NPCTraits[94].Height = 54;

    NPCTraits[198].Width = 32; // Peach
    NPCTraits[198].Height = 64;
    NPCTraits[198].FrameOffsetY = 2;
    NPCTraits[94].FrameOffsetY = 2;
    // NPCIsToad(94) = true;
    // NPCIsToad(198) = true;
    NPCTraits[95].Width = 32; // Green Yoshi
    NPCTraits[95].Height = 32;
    NPCTraits[95].WidthGFX = 74;
    NPCTraits[95].HeightGFX = 56;
    NPCTraits[95].FrameOffsetY = 2;
    NPCTraits[95].NoYoshi = true;
    NPCTraits[96].Width = 32; // Yoshi Egg
    NPCTraits[96].Height = 32;
    NPCTraits[97].Width = 32; // SMB3 Star
    NPCTraits[97].Height = 32;
    NPCTraits[98].Width = 32; // Blue Yoshi
    NPCTraits[98].Height = 32;
    NPCTraits[98].WidthGFX = 74;
    NPCTraits[98].HeightGFX = 56;
    NPCTraits[98].FrameOffsetY = 2;
    NPCTraits[99].Width = 32; // Yellow Yoshi
    NPCTraits[99].Height = 32;
    NPCTraits[99].WidthGFX = 74;
    NPCTraits[99].HeightGFX = 56;
    NPCTraits[99].FrameOffsetY = 2;
    NPCTraits[100].Width = 32; // Red Yoshi
    NPCTraits[100].Height = 32;
    NPCTraits[100].WidthGFX = 74;
    NPCTraits[100].HeightGFX = 56;
    NPCTraits[100].FrameOffsetY = 2;
    NPCTraits[101].Width = 28; // Luigi
    NPCTraits[101].Height = 62;
    NPCTraits[101].FrameOffsetY = 2;
    // NPCIsToad(101) = true;
    NPCTraits[102].Width = 32; // Link
    NPCTraits[102].Height = 64;
    NPCTraits[102].FrameOffsetY = 2;
    // NPCIsToad(102) = true;
    NPCTraits[103].Width = 28; // SMB3 Red Coin
    NPCTraits[103].Height = 32;
    NPCTraits[104].Width = 96; // SMB3 Platform
    NPCTraits[104].Height = 32;
    NPCTraits[104].NoYoshi = true;
    NPCTraits[105].Width = 128; // SMW Falling Platform
    NPCTraits[105].Height = 22;
    NPCTraits[105].NoYoshi = true;
    NPCTraits[106].Width = 128; // SMB Platform
    NPCTraits[106].Height = 16;
    NPCTraits[106].NoYoshi = true;
    NPCTraits[107].Width = 24; // Bob-omb buddy
    NPCTraits[107].Height = 38;
    NPCTraits[107].WidthGFX = 48;
    NPCTraits[107].HeightGFX = 38;
    NPCTraits[107].FrameOffsetY = 2;
    // NPCIsToad(107) = true;
    NPCTraits[108].Width = 32; // Yoshi Fireball
    NPCTraits[108].Height = 32;
    NPCTraits[108].NoYoshi = true;
    NPCTraits[109].Width = 32; // SMW Green Koopa
    NPCTraits[109].Height = 32;
    NPCTraits[109].WidthGFX = 32;
    NPCTraits[109].HeightGFX = 54;
    NPCTraits[109].FrameOffsetY = 2;
    // NPCDefaultMovement(109) = true;
    NPCTraits[110].Width = 32; // SMW Red Koopa
    NPCTraits[110].Height = 32;
    ...
    NPCTraits[111].Width = 32; // SMW Blue Koopa
    NPCTraits[111].Height = 32;
    ...
    NPCTraits[112].Width = 32; // SMW Yellow Koopa
    NPCTraits[112].Height = 32;
    ...
    NPCTraits[135].Width = 32; // SMB2 Bob-om
    NPCTraits[135].Height = 32;
    NPCTraits[135].GrabFromTop = true;
    NPCTraits[135].CanWalkOn = true;
    // NPCDefaultMovement(135) = true;
    NPCTraits[136].Width = 32; // SMB3 Bob-om
    NPCTraits[136].Height = 32;
    NPCTraits[136].FrameOffsetY = 2;
    // NPCDefaultMovement(136) = true;
    NPCTraits[136].TurnsAtCliffs = true;
    NPCTraits[137].Width = 32; // SMB3 Bomb
    NPCTraits[137].Height = 28;
    NPCTraits[137].FrameOffsetY = 2;
    NPCTraits[137].IsGrabbable = true;
    NPCTraits[138].Width = 28; // SMB 2 Coin
    NPCTraits[138].Height = 32;
    // NPCIsABonus(138) = true;
    // NPCIsACoin(138) = true;
    NPCTraits[152].Width = 32; // Sonic Ring
    NPCTraits[152].Height = 32;
    // NPCIsABonus(152) = true;
    // NPCIsACoin(152) = true;
    For(A, 139, 147) // Veggies
    {
        NPCTraits[A].Width = GFXNPC[A].w;
        NPCTraits[A].Height = GFXNPC[A].h;
    ...
    NPCTraits[148].Width = 32; // Black Yoshi
    NPCTraits[148].Height = 32;
    NPCTraits[148].WidthGFX = 74;
    NPCTraits[148].HeightGFX = 56;
    NPCTraits[148].FrameOffsetY = 2;
    NPCTraits[148].NoYoshi = true;
    NPCTraits[149].Width = 32; // Purple Yoshi
    NPCTraits[149].Height = 32;
    NPCTraits[149].WidthGFX = 74;
    NPCTraits[149].HeightGFX = 56;
    NPCTraits[149].FrameOffsetY = 2;
    NPCTraits[149].NoYoshi = true;
    NPCTraits[150].Width = 32; // Pink Yoshi
    NPCTraits[150].Height = 32;
    NPCTraits[150].WidthGFX = 74;
    NPCTraits[150].HeightGFX = 56;
    NPCTraits[150].FrameOffsetY = 2;
    NPCTraits[228].Width = 32; // Ice Yoshi
    NPCTraits[228].Height = 32;
    NPCTraits[228].WidthGFX = 74;
    NPCTraits[228].HeightGFX = 56;
    NPCTraits[228].FrameOffsetY = 2;
    NPCTraits[151].Width = 48; // SMW Sign
    NPCTraits[151].Height = 48;
    NPCTraits[151].NoYoshi = true;
    NPCTraits[151].WontHurt = true;
    NPCTraits[151].NoClipping = true;
    NPCTraits[154].Width = 32; // SMB2 Mushroom Block
    NPCTraits[154].Height = 32;
    NPCTraits[155].Width = 32; // SMB2 Mushroom Block
    NPCTraits[155].Height = 32;
    NPCTraits[156].Width = 32; // SMB2 Mushroom Block
    NPCTraits[156].Height = 32;
    NPCTraits[157].Width = 32; // SMB2 Mushroom Block
    NPCTraits[157].Height = 32;
    NPCTraits[158].Width = 32; // Mr Saturn
    NPCTraits[158].Height = 42;
    NPCTraits[158].FrameOffsetY = 2;
    NPCTraits[158].JumpHurt = true;
    NPCTraits[159].Width = 32; // Diggable Dirt
    NPCTraits[159].Height = 32;
    NPCTraits[160].Width = 128; // Airship Rocket
    NPCTraits[160].Height = 32;
    NPCTraits[160].WidthGFX = 316;
    NPCTraits[160].HeightGFX = 32;
    NPCTraits[160].NoYoshi = true;
    NPCTraits[154].Width = 32; // SMB2 Mushroom Block
    NPCTraits[154].Height = 32;
    NPCTraits[162].Width = 32; // SMW Rex
    NPCTraits[162].Height = 60;
    NPCTraits[162].WidthGFX = 40;
    NPCTraits[162].HeightGFX = 64;
    NPCTraits[162].FrameOffsetY = 2;
    NPCTraits[163].Width = 32; // SMW Rex Smashed
    NPCTraits[163].Height = 32;
    NPCTraits[163].WidthGFX = 32;
    NPCTraits[163].HeightGFX = 32;
    NPCTraits[163].FrameOffsetY = 2;
    NPCTraits[164].Width = 58; // SMW Mega Mole
    NPCTraits[164].Height = 58;
    NPCTraits[164].WidthGFX = 64;
    NPCTraits[164].HeightGFX = 64;
    NPCTraits[164].FrameOffsetY = 2;
    NPCTraits[165].Width = 32; // SMW Goomba
    NPCTraits[165].Height = 32;
    NPCTraits[165].FrameOffsetY = 2;
    NPCTraits[166].Width = 32; // SMW Stomped Goomba Goomba
    NPCTraits[166].Height = 32;
    NPCTraits[166].FrameOffsetY = 2;
    NPCTraits[167].Width = 32; // SMW Para-Goomba
    NPCTraits[167].Height = 32;
    NPCTraits[167].WidthGFX = 66;
    NPCTraits[167].HeightGFX = 50;
    NPCTraits[167].FrameOffsetY = 2;
    NPCTraits[168].Width = 26; // Bully
    NPCTraits[168].Height = 30;
    NPCTraits[168].WidthGFX = 26;
    NPCTraits[168].HeightGFX = 46;
    NPCTraits[168].FrameOffsetY = 2;
    NPCTraits[169].Width = 32; // Tanooki Suit
    NPCTraits[169].Height = 32;
    NPCTraits[169].FrameOffsetY = 2;
    // NPCIsABonus(169) = true;
    NPCTraits[170].Width = 32; // Hammer Suit
    NPCTraits[170].Height = 32;
    ...
    NPCTraits[171].Width = 16; // Hammer Suit Hammer
    NPCTraits[171].Height = 28;
    NPCTraits[171].WontHurt = true;
    NPCTraits[171].NoClipping = true;
    NPCTraits[171].NoYoshi = true;

    NPCTraits[172].Height = 28; //  Green SMB1 Shell
    // NPCIsAShell(172) = true;
    NPCTraits[174].Height = 28; //  Red SMB1 Shell
    ...
    NPCTraits[179].Width = 48;
    NPCTraits[179].Height = 48;
    NPCTraits[179].FrameOffsetY = 8;
    NPCTraits[180].JumpHurt = true; // SMW Thwomp
    NPCTraits[180].Width = 48;
    NPCTraits[180].Height = 64;
    NPCTraits[241].Width = 32; // POW
    NPCTraits[241].Height = 32; // POW
    ...
    NPCTraits[181].Width = 48;
    NPCTraits[181].Height = 46;
    NPCTraits[181].FrameOffsetY = 2;
    NPCTraits[197].Width = 48;
    NPCTraits[197].Height = 16;
    ...
    NPCTraits[188].Width = 30;
    NPCTraits[189].Width = 32;

    NPCTraits[201].NoYoshi = true;
    NPCTraits[202].NoYoshi = true;
    NPCTraits[202].JumpHurt = true;
    NPCTraits[201].Width = 80;
    NPCTraits[201].Height = 94;

    NPCTraits[199].Width = 56;
    NPCTraits[199].Height = 60;
    ...
    NPCTraits[203].Width = 46;
    NPCTraits[203].Height = 26;
    NPCTraits[203].NoYoshi = true;
    ...
    NPCTraits[209].Width = 96;
    NPCTraits[209].Height = 106;
    ...
    NPCTraits[272].Width = 32;
    NPCTraits[272].Height = 32;

    NPCTraits[208].CanWalkOn = true;
    NPCTraits[208].WontHurt = true;
    NPCTraits[208].MovesPlayer = true;
    NPCTraits[208].Width = 128;
    NPCTraits[208].Height = 128;
    ...
    NPCTraits[204].Width = 48;
    NPCTraits[204].Height = 28;
    ...
    NPCTraits[270].Width = 32;
    NPCTraits[270].Height = 42;
    NPCTraits[270].JumpHurt = true;
    NPCTraits[270].NoClipping = true;

    NPCTraits[271].Width = 32;
    NPCTraits[271].Height = 32;
    NPCTraits[271].NoClipping = true;


    NPCTraits[210].Width = 28;
    ...
    // link sword beam
    NPCTraits[266].Width = 16;
    NPCTraits[266].Height = 8;

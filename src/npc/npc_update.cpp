...
void UpdateNPCs()
{
    ...
    for(A = 1; A <= numNPCs; A++)
    {
        ...
        if(NPC[A].JustActivated != 0)
        {
            if(NPC[A].Active == true)
            {
                ...
                else if(NPC[A].Type == 17 || NPC[A].Type == 18 || (NPCIsCheep[NPC[A].Type] && NPC[A].Special == 2) || NPC[A].Type == 42) // Special Start for Jumping Fish and Bullet Bills
                {
                    ...
                    else if(NPCIsCheep[NPC[A].Type] && NPC[A].Special == 2)
                    {
        ...
        else if(!(NPCIsCheep[NPC[A].Type] && NPC[A].Special == 2) && !(NPC[A].Type == 12))
        {
        ...
        else if(NPC[A].Active == true && NPC[A].Killed == 0 && NPC[A].Generator == false)
        {
            ...
            if(NPC[A].Effect == 0)
            {
                            ...
                            for(B = 1; B <= numNPCs; B++)
                            {
                                if(B != A && NPC[B].Active == true &&
                                    ...
                                    (!(NPC[B].Type == 265) || (BattleMode == true && NPC[B].CantHurtPlayer != NPC[A].HoldingPlayer)) &&
                                     ...
                                     !(NPC[B].Type == 35) && !(NPC[B].Type == 193 && NPC[A].Type == 193) && !(NPC[B].Type == 37) &&
                                     !(NPC[B].Type == 180) && !(NPC[B].Type == 38) && !(NPC[B].Type == 39) &&
                                     !(NPC[B].Type == 45 && NPC[B].Special == 0) && !(NPC[B].Type == 91) && !(NPC[B].Type == 159) &&
                                     !(NPC[B].Type == 195) && !(NPC[B].Type == 30 && NPC[B].Projectile == true) &&
                                       NPC[B].Type != 241 && NPC[B].Type != 263 && NPC[B].Type != 291)
                                {
                ...
                else // NPC is not held
                {
                    ...
                    if(NPC[A].TurnAround == true)
                    {
                        ...
                        if(NPC[A].Type == 265)
                            NPCHit(A, 3, A);
                        if(NPCIsAShell[NPC[A].Type] == true && NPC[A].Location.SpeedX != 0.0 && NPC[A].Special4 == 0.0)
                        {
                            NPC[A].Special4 = 5;
                ...
                else if(NPC[A].Type == 9 || NPC[A].Type == 273 || NPC[A].Type == 90 || NPC[A].Type == 153 || NPC[A].Type == 184 || NPC[A].Type == 185 || NPC[A].Type == 186 || NPC[A].Type == 187 || NPC[A].Type == 163 || NPC[A].Type == 164)
                {
                    if(NPC[A].Direction == 0) // Move toward the closest player
                    {
                        ...
                        for(B = 1; B <= numPlayers; B++)
                        {
                            ...
                            {
                                if(C == 0 || Abs(NPC[A].Location.X + NPC[A].Location.Width / 2.0 - (Player[B].Location.X + Player[B].Location.Width / 2.0)) < C)
                                {
                                    C = Abs(NPC[A].Location.X + NPC[A].Location.Width / 2.0 - (Player[B].Location.X + Player[B].Location.Width / 2.0));
                                                ...
                                                if(!(NPC[A].Block == B) && !(NPC[A].tempBlock == B) && !(NPC[A].Projectile == true && Block[B].noProjClipping == true) && BlockNoClipping[Block[B].Type] == false && Block[B].Hidden == false)
                                                {
                                                    ...
                                                    if((NPC[A].Type == 55 || NPC[A].Type == 119) && Block[B].IsNPC == 45)
                                                    {
                                                        if(HitSpot == 2 || HitSpot == 4)
                                                        {
                                                            if(NPC[A].Location.SpeedY == Physics.NPCGravity ||
                                                              ...
                                                              (oldSlope > 0 && NPC[Block[B].IsReally].Projectile == false))
                                                            {
                                                    ...
                                                    if(HitSpot == 1) // Hitspot 1
                                                    {
                                                        ...
                                                        if(tempHitBlock == B)
                                                        {
                                                            ...
                                                            if(
                                                                (
                                                                  (NPCStandsOnPlayer[NPC[A].Type] == true && NPC[A].Projectile == false) ||
                                                                        ...
                                                                        if(((NPC[A].Type == 55 || NPC[A].Type == 119) && NPCIsAShell[NPC[B].Type]) || ((NPC[B].Type == 55 || NPC[B].Type == 119) && NPCIsAShell[NPC[A].Type])) // Nekkid koopa kicking a shell
                                                                        {
                                                                            if(NPC[A].Type == 55 || NPC[A].Type == 119)
                                                                            {
                                                                                if(NPC[A].Location.SpeedY == Physics.NPCGravity || NPC[A].Slope > 0)
                                                                                {
                                                                                    ...
                                                                                    if((NPC[A].Direction == 1 &&
                                                                                        NPC[A].Location.X + NPC[A].Location.Width < NPC[B].Location.X + 4) ||
                                                                                       (NPC[A].Direction == -1 && NPC[A].Location.X > NPC[B].Location.X + NPC[B].Location.Width - 4))
                                                                                    {
                                                                                        if(NPC[B].Location.SpeedX == 0 && NPC[B].Effect == 0)
                                                                                        {
                                                                                            NPC[A].Special = 10;
                                                                                            Player[numPlayers + 1].Direction = NPC[A].Direction;
                                                                                            NPC[A].Location.X = NPC[A].Location.X - NPC[A].Direction;
            ...
            else if(NPC[A].Type == 189)
            {
                ...
                {
                    NPC[A].Special2 = NPC[A].Special2 + 1;
                    if(NPC[A].Special2 >= 400 && NPC[A].Special3 == 0.0)
                    {
                        NPC[A].Special = 0;
                        NPC[A].Special2 = 0;
                        NPC[A].Inert = false;

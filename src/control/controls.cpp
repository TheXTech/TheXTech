...
{
    MenuControls_t ret;
    ret.Up = SharedControls.MenuUp;
    ret.Down = SharedControls.MenuDown;
    ret.Left = SharedControls.MenuLeft;
    ret.Right = SharedControls.MenuRight;
    ret.Home = SharedCursor.Tertiary;

    ret.Do = SharedControls.MenuDo || SharedControls.Pause;
    ret.Back = SharedControls.MenuBack;

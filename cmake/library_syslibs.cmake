...
if(APPLE)
    ...
    if(MACOS)
        ...
        xtech_add_macos_library(UIKit)
        xtech_add_macos_library(CoreGraphics)
    endif()
    ...
    if(MACOS)
        ...
        xtech_add_macos_library(Foundation)
        xtech_add_macos_library(CoreMotion)
        xtech_add_macos_library(CoreBluetooth)
        xtech_add_macos_library(StoreKit)
        xtech_add_macos_library(QuartzCore)

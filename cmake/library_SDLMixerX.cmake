...
if(WIN32)
    if(MSVC)
        ...
        set(SDL_MixerX_SO_Lib "${DEPENDENCIES_INSTALL_DIR}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2_mixer_ext${PGE_LIBS_DEBUG_SUFFIX}.dll.a")
        set(SDL2_SO_Lib "${DEPENDENCIES_INSTALL_DIR}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2${PGE_LIBS_DEBUG_SUFFIX}.dll.a")
    endif()
else()
...
set(MixerX_CodecLibs
    ...
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}vorbis${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}opusfile${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}opus${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}ogg${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}mad${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}ADLMIDI${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}OPNMIDI${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}timidity_sdl2${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}gme${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}xmp${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}modplug${CMAKE_STATIC_LIBRARY_SUFFIX}"
    "${SDL2_LIBRARIES}/${CMAKE_STATIC_LIBRARY_PREFIX}zlib${CMAKE_STATIC_LIBRARY_SUFFIX}"
)

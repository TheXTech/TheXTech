...
elseif(EMSCRIPTEN OR ANDROID OR IOS OR VITA OR NINTENDO_SWITCH OR NINTENDO_WII OR NINTENDO_WIIU OR NINTENDO_3DS)
...
set(XTECH_PLATFORM_MIXERX_CMAKE_FLAGS)
set(XTECH_PLATFORM_AUDIOCODECS_CMAKE_FLAGS)
...
list(REMOVE_DUPLICATES XTECH_PLATFORM_AUDIOCODECS_CMAKE_FLAGS)

#message("DEBUG: Audio Codecs CMake: arguments: ${XTECH_PLATFORM_AUDIOCODECS_CMAKE_FLAGS}")
...
#   UPDATE_COMMAND ""
    ...
    CMAKE_ARGS
        ...
        ${XTECH_PLATFORM_AUDIOCODECS_CMAKE_FLAGS}
...
if(NOT THEXTECH_NO_MIXER_X)
    ...
    #    UPDATE_COMMAND ""
        ...
        CMAKE_ARGS
            ...
            ${XTECH_PLATFORM_GENERAL_CMAKE_FLAGS}
            ${XTECH_PLATFORM_MIXERX_CMAKE_FLAGS}
        DEPENDS ${MixerX_Deps}
        BUILD_BYPRODUCTS
            "${SDL_MixerX_SO_Lib}"
            "${SDL_MixerX_A_Lib}"
...
elseif((WIN32 AND MSVC) OR NINTENDO_3DS OR VITA OR IOS)

...
if(HAIKU)
    ...
    if(NOT DEFINED THEXTECH_HAIKU_VERSION_BUILD_NUMBER OR "${THEXTECH_VERSION_REL}" STREQUAL "")
        # Set just 1 for releases and when build number is not defined
        set(THEXTECH_HAIKU_VERSION_BUILD_NUMBER 1)
    endif()
    ...
    string(CONCAT THEXTECH_HAIKU_VERSION_STRING "${THEXTECH_HAIKU_VERSION_STRING}" "-${THEXTECH_HAIKU_VERSION_BUILD_NUMBER}")
endif()
